...
||1. Validate all hyperlinks from the response of People resource|Completed|
||2. Validate count matches with the overall number of People results|Completed|
||3. Validate whether films key has only URLs for films resources|Completed|
...
![HTML-Test-Result-example](HTML-Test-Result-example_1.png)
